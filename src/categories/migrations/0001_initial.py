    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_logo', models.CharField(blank=True, max_length=50, null=True)),
                ('category_slug', models.SlugField(blank=True, null=True, verbose_name='Slug')),
                ('image_prod', models.ImageField(blank=True, height_field='height_field', null=True, upload_to=categories.models.upload_location, width_field='width_field')),
