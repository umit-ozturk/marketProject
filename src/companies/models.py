...
class Company(MPTTModel):
	...
	company_name 		= models.CharField(max_length=140, verbose_name='Firma İsmi')
	company_site 		= models.CharField(max_length=140, verbose_name='Firmanın Sitesi')
	image_comp		 	= models.ImageField(upload_to=upload_location,
					 		null=True, blank=True,
							width_field="width_field", 
			 				height_field="height_field",
			 				verbose_name="Firma Resmi")
