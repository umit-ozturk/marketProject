# Generated by Django 2.0.2 on 2019-04-28 18:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('companies', '0002_auto_20190428_1833'),
        ('categories', '0002_auto_20190428_1833'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Ürün Rengi')),
                ('size', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Ürün Boyutu')),
                ('weight', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Ürün Ağırlığı')),
                ('number', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Ürün Numarası')),
                ('body', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Ürün Bedeni')),
