        ...
        self.helper.layout = Layout(
            Div(
                ...
                Div(
                    ...
                    Field('username', ), css_class='col-md-12 input-group'
            ...
            Div(
                ...
                Div(
                    ...
                    Field('password', ), css_class='col-md-12 input-group'
                    ), css_class='form-group col-md-6'
                ),
            Div(
                HTML(
                ...
                Div(
                    ...
                    Field('password2', ), css_class='col-md-12 input-group'
                    ), css_class='form-group col-md-6'
                ),
            Div(
                HTML(
                ...
                Div(
                    ...
                    Field('email', ), css_class='col-md-12 input-group'
                    ), css_class='form-group col-md-6'
                ),
            Div(
                HTML(
                ...
                Div(
                    ...
                    Field('email2', ), css_class='col-md-12 input-group'
                    ), css_class='form-group col-md-6'
                ),
            Div(
                Div(
                    Field('info',
                          HTML(
                            "<div class='form-group'><div class='checkbox checbox-switch switch-danger'><label>"
                            "<input type='checkbox' name='info' checked='' /><span></span>Bilgilendirmelerden beni "
                            "haberdar et.</label></div></div>",
                            ), style=""
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                Div(
                    HTML(
                        "<input id='userphoto' name='userphoto' type='file' style='display:None;' capture>"
                        "<img id='UserPhoto' alt='User Pic' src='/media/{{object.userphoto}}' "
                        "class='img-circle img-responsive' style='cursor: pointer;'>"
                        ), css_class='col-md-3 col-lg-3'
                    ),

                Div(
                    HTML(
                        "<table class='table table-user-information'><tbody><tr><td>İsim:</td><td><input id='name'"
                        " type='text' name='name' placeholder='{{object.name}}'></td></tr><tr><td>Soyisim:</td><td>"
                        "<input id='surname' type='text' name='surname' placeholder='{{object.surname}}'></td></tr><tr>"
                        "<td>Doğum Tarihi:</td><td><input id='birthday' type='date' name='birthday' "
                        "placeholder='{{object.birthday}}'></td></tr><tr><tr><td>Cinsiyet:</td><td><input type='radio'"
                        " name='gender' value='E'> Erkek<br><input type='radio' name='gender' value='K'> Kadın<br></td>"
                        "</tr><tr><td>Adres:</td><td><input id='adress' type='text' name='adress'"
                        " placeholder='{{object.adress}}'></td></tr><tr><td>Email:</td><td><input type='email'"
                        " name='lname' placeholder='{{user.email}}'></td></tr><td>Telefon Numarası:</td><td>"
                        "<input id='phone' type='tel' name='phone' placeholder='{{object.phone}}'></td></tr></tbody>"
                        "</table><button class='btn btn-fill' type='submit'>Kaydet</button><a href='/profile/{{user}}/'"
                        " class='btn btn-primary'>Geri Dön</a>"
